...
; Example .......: No
; ===============================================================================================================================
Func _CaptureRegion2(Const $iLeft = 0, Const $iTop = 0, Const $iRight = $res_width, Const $iBottom = $res_height)
...
; Example .......: No
; ===============================================================================================================================
Func _CaptureGameScreen(ByRef $_hHBitmap, Const $iLeft = 0, Const $iTop = 0, Const $iRight = $res_width, Const $iBottom = $res_height)
	Local $SuspendMode
	...
	If $g_hHBitmapTest = 0 Then
	   #comments-start
		...
		#comments-end
			;getBSPos()
			;$SuspendMode = ResumeAndroid(False)
			$_hHBitmap = _ScreenCapture_Capture("", $iLeft , $iTop , $iRight, $iBottom, False)
			;SuspendAndroid($SuspendMode, False)
		;EndIf
